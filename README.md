# Maintenance: Procurement Filament

> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the maintenance-procurement public boundary. It
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-maintenance-procurement-filament?sort=semver)](https://github.com/liberusoftware/module-maintenance-procurement-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-maintenance-procurement-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-maintenance-procurement-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-maintenance-procurement-filament
```
...
<a href="https://github.com/liberusoftware/module-maintenance-procurement-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-maintenance-procurement-filament" alt="Contributors to liberusoftware/module-maintenance-procurement-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-maintenance-procurement-filament/graphs/contributors).
